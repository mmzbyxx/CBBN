...
class CIFAR10_LT(object):
    ...
    def __init__(self, distributed, root='./data/cifar10', imb_type='exp',
        ...
        train_balance_dataset = IMBALANCECIFAR10(root=root, imb_type=imb_type, imb_factor=imb_factor, rand_number=0, train=True, download=True, transform=train_transform)
        
        train_dataset = IMBALANCECIFAR10(root=root, imb_type=imb_type, imb_factor=imb_factor, rand_number=0, train=True, download=True, transform=TwoCropTransform(train_transform))
